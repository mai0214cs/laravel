...
@section ('breadcumb')
    ...
    <li class="active">{{$data[0]['Trang Sửa Nhà sản xuất']}}</li>
@stop()
...
<form class="form-horizontal" action="{{action('ProductProcedureController@confirmedit')}}" method="post">
...
<div class="row"><div class="col-sm-12">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10"><input type="text" class="form-control" value="{{$data[4]->address}}" name="address" /></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label">{{$data[0]['Điện thoại']}}</label>
          <div class="col-sm-10"><input type="text" class="form-control" value="{{$data[4]->phone}}" name="phone" /></div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label">{{$data[0]['Thư điện tử']}}</label>
          <div class="col-sm-10"><input type="text" class="form-control" value="{{$data[4]->email}}" name="email" /><p>{{$errors->first('email')}}</p></div>
        </div>
        <div class="form-group">
