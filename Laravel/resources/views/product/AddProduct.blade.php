...
@section ('breadcumb')
    ...
    <li class="active">{{$data[0]['Trang Thêm Sản phẩm']}}</li>
@stop()

@section ('content')
<div class="row"><form role="form" method="post" action="{{action('ProductListController@confirmadd')}}" onsubmit="return AddEditProduct()">
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="order" value="999" />
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <select style="min-height:300px;" multiple class="form-control" name="productrelated[]"></select>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <select style="min-height:300px;" multiple class="form-control" name="newsrelated[]"></select>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group" id="VideoProduct">
                    <input type="text" class="form-control" placeholder="Nhập URL Video" name="AddVideoNew" />
            ...
            <div class="form-group">
                ...
                <div class="tab-content">
                    <div id="tab1product" class="tab-pane fade in active">
                        ...
                        <div class="form-group">
                            <label>{{$data[0]['Chi tiết']}}</label>
                            <textarea name="tab_content_1"></textarea>
                        </div>
                    </div>
                    <div id="tab2product" class="tab-pane fade">
                        <div class="form-group">
                            <label>{{$data[0]['Tiêu đề']}}</label>
                            <input type="text" class="form-control" name="tab_title_2" />
                        </div>
                        <div class="form-group">
                            <label>{{$data[0]['Chi tiết']}}</label>
                            <textarea name="tab_content_2"></textarea>
                        </div>
                    </div>
                    <div id="tab3product" class="tab-pane fade">
                        <div class="form-group">
                            <label>{{$data[0]['Tiêu đề']}}</label>
                            <input type="text" class="form-control" name="tab_title_3" />
                        </div>
                        <div class="form-group">
                            <label>{{$data[0]['Chi tiết']}}</label>
                            <textarea name="tab_content_3"></textarea>
                        </div>
                    </div>
                    <div id="tab4product" class="tab-pane fade">
                        <div class="form-group">
                            <label>{{$data[0]['Tiêu đề']}}</label>
                            <input type="text" class="form-control" name="tab_title_4" />
                        </div>
                        <div class="form-group">
                            <label>{{$data[0]['Chi tiết']}}</label>
                            <textarea name="tab_content_4"></textarea>
                        </div>
                    </div>
                    <div id="tab5product" class="tab-pane fade">
                        <div class="form-group">
                            <label>{{$data[0]['Tiêu đề']}}</label>
                            <input type="text" class="form-control" name="tab_title_5" />
                        </div>
                        <div class="form-group">
                            <label>{{$data[0]['Chi tiết']}}</label>
                            <textarea name="tab_content_5"></textarea>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="url" placeholder="Nhập đường dẫn trang" />
            </div>
            <div class="form-group">
                <label>{{$data[0]['Trang hiển thị']}}</label>
                <select class="form-control" name="vpage">
                    <?php  foreach ($page as $v) {echo '<option value="'.$v->id.'">'.$v->name.'</option>';} ?>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" multiple="multiple" data-placeholder="" name="tags[]" style="width: 100%;">
                    <?php  
                    foreach ($tags as $v) {echo '<option value="'.$v->id.'">'.$v->{lang.'name'}.'</option>';} ?>
                </select>
            </div>
        </div>
    </div>
