...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="{{@asset('libadmin/plugins/iCheck/square/blue.css')}}">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="{{action('loginController@confirmlogin')}}" method="post">
          ...
          <div class="row">
            <div class="col-xs-8">
              <div class="checkbox icheck">
                <label>
                  <input type="checkbox"> Lưu tài khoản của tôi
                </label>
              </div>
            </div><!-- /.col -->
            <div class="col-xs-4">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="{{@asset('libadmin/plugins/jQuery/jQuery-2.1.4.min.js')}}"></script>
    <!-- Bootstrap 3.3.5 -->
    <script src="{{@asset('libadmin/bootstrap/js/bootstrap.min.js')}}"></script>
    <!-- iCheck -->
    <script src="{{@asset('libadmin/plugins/iCheck/icheck.min.js')}}"></script>
    <script>
      $(function () {
        $('input').iCheck({
